...
class IHM(Data_extraction):
    ...
    def __init__(self) -> None:
        ...
        texte1 = Label (self.fenetre, text= "affichage de graphes")
    ...
    def plot2(self):
        ...
        plt.title(" Traj : {}, alt : {}cm, pipe : {} ".format(traj+1, z, 1))
    ...
    def plot_real_z(self, ax, num_traj_list, num_dipole_list, z =5):
        ...
        for traj ,list_dipole in enumerate(traj_dipole_value) :
            ...
            plt.title(" Traj : {}, alt : {}cm, pipe : {} , dipole : {}".format(num_traj_list[traj]+1, z, self.pipe, self.dipole[i]))
            # plt.title(" Traj : {}, alt : {}cm, pipe : {} ".format(num_traj_list[traj]+1, z, self.pipe, i))
            plt.grid()
